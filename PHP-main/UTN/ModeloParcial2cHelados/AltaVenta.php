...
$rutaProductos = "Heladeria.json"; //OJO
...
$ventaAux = new Venta($usuarioAux,$productoAux,$cantidad, $archivo);

$indiceProductoAux = Toolkit::ConsultaSiHayYCual($productoAux, $arrayProductos);
...
if(isset($sabor) && isset($tipo) && isset($cantidad) && isset($email) && isset ($archivo))
{
    ...
    {     
        ...
        $stockProductoAuxEnArray = Toolkit::SacarValorDeClave($productoAuxEnArray, "_stock");
