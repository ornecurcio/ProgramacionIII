...
class Venta{
    ...
    public function __construct($id,$mailUsuario,$nombre,$tipo,$cantidad, $numeroDePedido,$fechaDePedido="", $precioTotal=0, $descuento=0)
    { 
        $this->id = $id;   
    ...
    public function GuardarImagen()
    {
        ...
        {
           echo "El archivo no pudo guardarse";
           return false;
        }
    }
