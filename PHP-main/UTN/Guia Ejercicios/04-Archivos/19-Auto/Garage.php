...
include "Auto.php";
   Class Garage
   {
        ...
        function __construct($razonSocial, $precioPorHora, $autos = array())
        {
        ...
        {
            //$bool = array_search($a,$this->_autos);
            //echo($bool);
            //return $bool;
        ...
        public static function EscribirGarage($garage)
        {
            if(file_exists('garage.csv'))
            {
                if(filesize('garage.csv')>0)
                {
            ...
            if($archivo!==false)
            {
                ...
                { 
                    fputcsv($archivo, get_object_vars($garage));
                    Autos::AltaAutos($garage->_autos);   
                }
                fclose($archivo);
            }
            else
        ...
        public static function LeerGarage()
        {
            ...
            {
                echo "Los datos de los garages son:"; 
